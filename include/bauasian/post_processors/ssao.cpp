...
void SSAO::process(unsigned short out_binding) const
{
...
void SSAO::setKernelSize(int kernel_size) const
{
	m_shader->setUniform(m_location_kernel_size, kernel_size);
}

void SSAO::setRadius(float radius) const
{
	m_shader->setUniform(m_location_ssao_radius, radius);
}

void SSAO::setPower(float power) const
{
